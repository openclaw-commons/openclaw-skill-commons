...
# 查看帮助
openclaw diagram-generator --help

# 指定配置
openclaw diagram-generator --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Diagram Generator功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw diagram-generator --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw diagram-generator | openclaw task-decomposer
```
