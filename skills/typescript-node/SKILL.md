...
```bash
npx clawhub@latest install typescript-node
```
...
# 查看帮助
openclaw typescript-node --help

# 指定配置
openclaw typescript-node --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Typescript Node功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw typescript-node --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw typescript-node | openclaw task-decomposer
```
