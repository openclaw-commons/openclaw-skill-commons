...
```bash
npx clawhub@latest install wso2-guide
```
...
# 查看帮助
openclaw wso2-guide --help

# 指定配置
openclaw wso2-guide --config ./config.yaml
```
...
```bash
openclaw wso2-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw wso2-guide | openclaw task-decomposer
```
