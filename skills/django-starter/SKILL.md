...
```bash
npx clawhub@latest install django-starter
```
...
```bash
# 使用默认配置
openclaw django-starter

# 查看帮助
openclaw django-starter --help

# 指定配置
openclaw django-starter --config ./config.yaml
```
...
```bash
openclaw django-starter --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw django-starter | openclaw task-decomposer
```
