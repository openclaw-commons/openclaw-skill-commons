...
# 查看帮助
openclaw task-decomposer --help

# 指定配置
openclaw task-decomposer --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Task Decomposer功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw task-decomposer --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw task-decomposer | openclaw task-decomposer
```
