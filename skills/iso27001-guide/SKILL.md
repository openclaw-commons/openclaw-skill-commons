...
```bash
npx clawhub@latest install iso27001-guide
```
...
```bash
# 使用默认配置
openclaw iso27001-guide

# 查看帮助
openclaw iso27001-guide --help

# 指定配置
openclaw iso27001-guide --config ./config.yaml
```
...
```bash
openclaw iso27001-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw iso27001-guide | openclaw task-decomposer
```
