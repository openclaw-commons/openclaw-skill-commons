...
```bash
npx clawhub@latest install api-integration
```
...
# 查看帮助
openclaw api-integration --help

# 指定配置
openclaw api-integration --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Api Integration功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw api-integration --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw api-integration | openclaw task-decomposer
```
