...
```bash
npx clawhub@latest install incident-response
```
...
# 查看帮助
openclaw incident-response --help

# 指定配置
openclaw incident-response --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Incident Response功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw incident-response --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw incident-response | openclaw task-decomposer
```
