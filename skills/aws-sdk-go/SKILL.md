...
```bash
npx clawhub@latest install aws-sdk-go
```
...
# 查看帮助
openclaw aws-sdk-go --help

# 指定配置
openclaw aws-sdk-go --config ./config.yaml
```
...
```bash
openclaw aws-sdk-go --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw aws-sdk-go | openclaw task-decomposer
```
