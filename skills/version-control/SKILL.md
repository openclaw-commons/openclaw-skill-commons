...
```bash
npx clawhub@latest install version-control
```
...
# 查看帮助
openclaw version-control --help

# 指定配置
openclaw version-control --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Version Control功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw version-control --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw version-control | openclaw task-decomposer
```
