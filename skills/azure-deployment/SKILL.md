...
```bash
npx clawhub@latest install azure-deployment
```
...
# 查看帮助
openclaw azure-deployment --help

# 指定配置
openclaw azure-deployment --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Azure Deployment功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw azure-deployment --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw azure-deployment | openclaw task-decomposer
```
