...
```bash
npx clawhub@latest install ai-writing
```
...
# 查看帮助
openclaw ai-writing --help

# 指定配置
openclaw ai-writing --config ./config.yaml
```
...
```bash
openclaw ai-writing --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw ai-writing | openclaw task-decomposer
```
