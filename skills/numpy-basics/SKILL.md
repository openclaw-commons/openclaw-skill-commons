...
```bash
npx clawhub@latest install numpy-basics
```
...
```bash
# 使用默认配置
openclaw numpy-basics

# 查看帮助
openclaw numpy-basics --help

# 指定配置
openclaw numpy-basics --config ./config.yaml
```
...
```bash
openclaw numpy-basics --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw numpy-basics | openclaw task-decomposer
```
