...
```bash
# 使用默认配置
openclaw project-context-sync

# 查看帮助
openclaw project-context-sync --help

# 指定配置
openclaw project-context-sync --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Project Context Sync功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw project-context-sync --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw project-context-sync | openclaw task-decomposer
```
