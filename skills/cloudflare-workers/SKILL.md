...
```bash
npx clawhub@latest install cloudflare-workers
```
...
# 查看帮助
openclaw cloudflare-workers --help

# 指定配置
openclaw cloudflare-workers --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Cloudflare Workers功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw cloudflare-workers --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw cloudflare-workers | openclaw task-decomposer
```
