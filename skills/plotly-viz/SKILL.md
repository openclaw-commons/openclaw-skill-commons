...
```bash
npx clawhub@latest install plotly-viz
```
...
# 查看帮助
openclaw plotly-viz --help

# 指定配置
openclaw plotly-viz --config ./config.yaml
```
...
```bash
openclaw plotly-viz --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw plotly-viz | openclaw task-decomposer
```
