...
```bash
# 使用默认配置
openclaw conventional-commits

# 查看帮助
openclaw conventional-commits --help

# 指定配置
openclaw conventional-commits --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Conventional Commits功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw conventional-commits --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw conventional-commits | openclaw task-decomposer
```
