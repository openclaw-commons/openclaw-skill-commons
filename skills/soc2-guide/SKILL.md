...
```bash
npx clawhub@latest install soc2-guide
```
...
# 查看帮助
openclaw soc2-guide --help

# 指定配置
openclaw soc2-guide --config ./config.yaml
```
...
```bash
openclaw soc2-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw soc2-guide | openclaw task-decomposer
```
