...
# 查看帮助
openclaw daily-briefing --help

# 指定配置
openclaw daily-briefing --config ./config.yaml
```
...
```bash
openclaw daily-briefing --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw daily-briefing | openclaw task-decomposer
```
