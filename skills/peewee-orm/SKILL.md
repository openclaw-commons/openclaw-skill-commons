...
```bash
npx clawhub@latest install peewee-orm
```
...
# 查看帮助
openclaw peewee-orm --help

# 指定配置
openclaw peewee-orm --config ./config.yaml
```
...
```bash
openclaw peewee-orm --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw peewee-orm | openclaw task-decomposer
```
