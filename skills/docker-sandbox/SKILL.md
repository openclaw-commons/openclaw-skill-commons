...
# 查看帮助
openclaw docker-sandbox --help

# 指定配置
openclaw docker-sandbox --config ./config.yaml
```
...
```bash
openclaw docker-sandbox --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw docker-sandbox | openclaw task-decomposer
```
