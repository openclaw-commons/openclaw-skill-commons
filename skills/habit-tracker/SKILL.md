...
# 查看帮助
openclaw habit-tracker --help

# 指定配置
openclaw habit-tracker --config ./config.yaml
```
...
```bash
openclaw habit-tracker --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw habit-tracker | openclaw task-decomposer
```
