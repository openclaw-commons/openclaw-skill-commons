...
```bash
npx clawhub@latest install encryption-guide
```
...
# 查看帮助
openclaw encryption-guide --help

# 指定配置
openclaw encryption-guide --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Encryption Guide功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw encryption-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw encryption-guide | openclaw task-decomposer
```
