...
```bash
npx clawhub@latest install integration-test
```
...
# 查看帮助
openclaw integration-test --help

# 指定配置
openclaw integration-test --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Integration Test功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw integration-test --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw integration-test | openclaw task-decomposer
```
