...
# 查看帮助
openclaw sql-toolkit --help

# 指定配置
openclaw sql-toolkit --config ./config.yaml
```
...
```bash
openclaw sql-toolkit --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw sql-toolkit | openclaw task-decomposer
```
