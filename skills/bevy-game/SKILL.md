...
```bash
npx clawhub@latest install bevy-game
```
...
# 查看帮助
openclaw bevy-game --help

# 指定配置
openclaw bevy-game --config ./config.yaml
```
...
```bash
openclaw bevy-game --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw bevy-game | openclaw task-decomposer
```
