...
# 查看帮助
openclaw discord-bot --help

# 指定配置
openclaw discord-bot --config ./config.yaml
```
...
```bash
openclaw discord-bot --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw discord-bot | openclaw task-decomposer
```
