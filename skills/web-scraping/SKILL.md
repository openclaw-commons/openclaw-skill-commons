...
# 查看帮助
openclaw web-scraping --help

# 指定配置
openclaw web-scraping --config ./config.yaml
```
...
```bash
openclaw web-scraping --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw web-scraping | openclaw task-decomposer
```
