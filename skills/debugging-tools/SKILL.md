...
```bash
npx clawhub@latest install debugging-tools
```
...
# 查看帮助
openclaw debugging-tools --help

# 指定配置
openclaw debugging-tools --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Debugging Tools功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw debugging-tools --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw debugging-tools | openclaw task-decomposer
```
