...
```bash
npx clawhub@latest install vwo-guide
```
...
# 查看帮助
openclaw vwo-guide --help

# 指定配置
openclaw vwo-guide --config ./config.yaml
```
...
```bash
openclaw vwo-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw vwo-guide | openclaw task-decomposer
```
