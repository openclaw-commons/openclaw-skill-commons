...
```bash
npx clawhub@latest install urllib3-guide
```
...
```bash
# 使用默认配置
openclaw urllib3-guide

# 查看帮助
openclaw urllib3-guide --help

# 指定配置
openclaw urllib3-guide --config ./config.yaml
```
...
```bash
openclaw urllib3-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw urllib3-guide | openclaw task-decomposer
```
