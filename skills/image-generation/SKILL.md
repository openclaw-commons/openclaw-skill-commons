...
# 查看帮助
openclaw image-generation --help

# 指定配置
openclaw image-generation --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Image Generation功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw image-generation --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw image-generation | openclaw task-decomposer
```
