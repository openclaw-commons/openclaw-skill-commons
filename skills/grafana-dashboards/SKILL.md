...
```bash
npx clawhub@latest install grafana-dashboards
```
...
# 查看帮助
openclaw grafana-dashboards --help

# 指定配置
openclaw grafana-dashboards --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Grafana Dashboards功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw grafana-dashboards --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw grafana-dashboards | openclaw task-decomposer
```
