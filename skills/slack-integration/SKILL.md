...
```bash
npx clawhub@latest install slack-integration
```
...
# 查看帮助
openclaw slack-integration --help

# 指定配置
openclaw slack-integration --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Slack Integration功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw slack-integration --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw slack-integration | openclaw task-decomposer
```
