...
```bash
npx clawhub@latest install emergency-rescue
```
...
# 查看帮助
openclaw emergency-rescue --help

# 指定配置
openclaw emergency-rescue --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Emergency Rescue功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw emergency-rescue --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw emergency-rescue | openclaw task-decomposer
```
