...
```bash
npx clawhub@latest install screenshot-tool
```
...
# 查看帮助
openclaw screenshot-tool --help

# 指定配置
openclaw screenshot-tool --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Screenshot Tool功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw screenshot-tool --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw screenshot-tool | openclaw task-decomposer
```
