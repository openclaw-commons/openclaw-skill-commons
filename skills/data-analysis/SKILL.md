...
```bash
# 使用默认配置
openclaw data-analysis

# 查看帮助
openclaw data-analysis --help

# 指定配置
openclaw data-analysis --config ./config.yaml
```
...
```bash
openclaw data-analysis --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw data-analysis | openclaw task-decomposer
```
