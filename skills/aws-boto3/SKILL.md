...
```bash
npx clawhub@latest install aws-boto3
```
...
# 查看帮助
openclaw aws-boto3 --help

# 指定配置
openclaw aws-boto3 --config ./config.yaml
```
...
```bash
openclaw aws-boto3 --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw aws-boto3 | openclaw task-decomposer
```
