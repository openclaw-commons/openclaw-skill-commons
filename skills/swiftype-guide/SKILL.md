...
```bash
npx clawhub@latest install swiftype-guide
```
...
```bash
# 使用默认配置
openclaw swiftype-guide

# 查看帮助
openclaw swiftype-guide --help

# 指定配置
openclaw swiftype-guide --config ./config.yaml
```
...
```bash
openclaw swiftype-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw swiftype-guide | openclaw task-decomposer
```
