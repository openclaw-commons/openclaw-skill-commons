...
# 查看帮助
openclaw pr-reviewer --help

# 指定配置
openclaw pr-reviewer --config ./config.yaml
```
...
```bash
openclaw pr-reviewer --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw pr-reviewer | openclaw task-decomposer
```
