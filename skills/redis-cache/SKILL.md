...
# 查看帮助
openclaw redis-cache --help

# 指定配置
openclaw redis-cache --config ./config.yaml
```
...
```bash
openclaw redis-cache --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw redis-cache | openclaw task-decomposer
```
