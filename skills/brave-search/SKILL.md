...
# 查看帮助
openclaw brave-search --help

# 指定配置
openclaw brave-search --config ./config.yaml
```
...
```bash
openclaw brave-search --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw brave-search | openclaw task-decomposer
```
