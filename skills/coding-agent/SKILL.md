...
# 查看帮助
openclaw coding-agent --help

# 指定配置
openclaw coding-agent --config ./config.yaml
```
...
```bash
openclaw coding-agent --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw coding-agent | openclaw task-decomposer
```
