...
# 查看帮助
openclaw security-hardening --help

# 指定配置
openclaw security-hardening --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Security Hardening功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw security-hardening --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw security-hardening | openclaw task-decomposer
```
