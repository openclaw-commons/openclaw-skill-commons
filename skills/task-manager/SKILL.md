...
# 查看帮助
openclaw task-manager --help

# 指定配置
openclaw task-manager --config ./config.yaml
```
...
```bash
openclaw task-manager --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw task-manager | openclaw task-decomposer
```
