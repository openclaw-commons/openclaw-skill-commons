...
```bash
npx clawhub@latest install voice-synthesis
```
...
# 查看帮助
openclaw voice-synthesis --help

# 指定配置
openclaw voice-synthesis --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Voice Synthesis功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw voice-synthesis --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw voice-synthesis | openclaw task-decomposer
```
