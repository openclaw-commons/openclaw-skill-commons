...
```bash
npx clawhub@latest install css3-guide
```
...
# 查看帮助
openclaw css3-guide --help

# 指定配置
openclaw css3-guide --config ./config.yaml
```
...
```bash
openclaw css3-guide --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw css3-guide | openclaw task-decomposer
```
