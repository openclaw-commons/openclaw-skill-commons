...
```bash
npx clawhub@latest install code-review-ai
```
...
```bash
# 使用默认配置
openclaw code-review-ai

# 查看帮助
openclaw code-review-ai --help

# 指定配置
openclaw code-review-ai --config ./config.yaml
```
...
```bash
openclaw code-review-ai --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw code-review-ai | openclaw task-decomposer
```
