...
```bash
npx clawhub@latest install coverage-report
```
...
# 查看帮助
openclaw coverage-report --help

# 指定配置
openclaw coverage-report --config ./config.yaml
```

## 📖 功能特性

- ✅ 完整的Coverage Report功能
- ✅ 开箱即用的默认配置
- ✅ 详细的文档和示例
- ✅ 社区支持和持续更新
- ✅ 与其他技能无缝集成
...
```bash
openclaw coverage-report --verbose --output ./output
```

### 与其他技能组合

```bash
openclaw coverage-report | openclaw task-decomposer
```
